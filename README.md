...
- `min_price` (integer): restrict the search to items above or equal to this value.
- `max_price` (integer): restrict the search to items below or equal to this value.
