...
- `min_price` (integer): restrict the search to items priced above or equal to this value.
- `max_price` (integer): restrict the search to items priced below or equal to this value.
